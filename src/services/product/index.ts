...
class ProductService {
  ...
  async getProducts(params:any): Promise<IProduct> {
    try {
      return await client(
        `${this.serverUrl}/products?${params}`,
  ...
  async getBrands(params:any): Promise<IProduct> {
    try {
      return await client(
        `${this.serverUrl}/products/brands?${params}`,
        {data: null, type: null, headers: {}}
      );
    } catch (e) {
      throw e
  ...
  async deleteBrands(brandId: string): Promise<IProduct> {
    try {
      return await client(
        `${this.serverUrl}/products/brand/delete`,
        {data: { brandId }, type: null, headers: {}}
      );
    } catch (e) {
      throw e
    }
  ...
  async updateBrand(data: any): Promise<IProduct> {
    try {
      return await client(
        `${this.serverUrl}/products/brand/update`,
  ...
  async chaneProductStatus(product: any): Promise<IProduct> {
    try {
      return await client(
        `${this.serverUrl}/products/update`,
        {data: { ...product }, type: null, headers: {}}
      );
    } catch (e) {
      throw e
    }
  ...
  async getVariants(params:any): Promise<IProduct> {
    try {
      return await client(
        `${this.serverUrl}/products/variants?${params}`,
        {data: null, type: null, headers: {}}
      );
    } catch (e) {
      throw e
