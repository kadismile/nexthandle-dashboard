        ...
        <div className="container-xxl">
          ...
          <div className="h-right d-flex align-items-center mr-5 mr-lg-0 order-1">
            ...
            <div className="dropdown zindex-popover">
              ...
              >
                <img src="/assets/images/flag/GB.png" alt="GB flag" />
              </a>
              <div className="dropdown-menu rounded-lg shadow border-0 dropdown-animation dropdown-menu-md-end p-0 m-0 mt-3">
                <div className="card border-0">
                  <ul className="list-unstyled py-2 px-3">
                    ...
                    <li>
                      <a href="/#" className={""}>
                        <img src="/assets/images/flag/DE.png" alt="DE flag" />{" "}
                        German
                      </a>
                    </li>
                    <li>
                      <a href="/#" className={""}>
                        <img src="/assets/images/flag/FR.png" alt="FR flag" />{" "}
                        French
                      </a>
                    </li>
                    <li>
                      <a href="/#" className={""}>
                        <img src="/assets/images/flag/IT.png" alt="IT flag" />{" "}
                        Italian
                      </a>
                    </li>
                    <li>
                      <a href="/#" className={""}>
                        <img src="/assets/images/flag/RU.png" alt="RU flag" />{" "}
                        Russian
                      </a>
                    </li>
                  </ul>
