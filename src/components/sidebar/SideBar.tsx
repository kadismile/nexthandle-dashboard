    ...
    <div className="sidebar px-4 py-4 py-md-4 me-0">
      <div className="d-flex flex-column h-100">
        ...
        <ul className="menu-list flex-grow-1 mt-3">
          <li>
            <a className={`m-link ${getActiveLink(["/"])}`} href="/">
          ...
          <li className="collapsed ">
            <a
              className={`m-link ${getActiveLink([
                "/products",
                "/product-brand",
                "/product-variant",
              ])}`}
              ...
              href="/#"
            >
              <i className="icofont-notepad fs-5" /> <span>Products</span>{" "}
            ...
            <ul className="sub-menu collapse" id="menu-order">
              <li>
                <Link
                  to="/products"
                  className={`ms-link ${getActiveLink(["/products"])}`}
                >
                  Product Lists
                </Link>
              </li>
              <li>
                <Link
                  to="/product-brand"
                  className={`ms-link ${getActiveLink(["/product-brand"])}`}
                >
                  Product Brand
                </Link>
              </li>
              <li>
                <Link
                  to="/product-variant"
                  className={`ms-link ${getActiveLink(["/product-variant"])}`}
                >
                  {" "}
                  Product Variants{" "}
                </Link>
              ...
              <li>
                <Link
                  to="/products-admin"
                  className={`ms-link ${getActiveLink(["/product-admin"])}`}
                >
                  {" "}
                  Admin Products{" "}
                </Link>
          ...
          <li>
            <Link
              to="/categories"
              className={`m-link ${getActiveLink(["/categories"])}`}
            >
          ...
          <li>
            <Link
              to="/vendors"
              className={`m-link ${getActiveLink(["/vendors"])}`}
            >
          ...
          <li>
            <a className="m-link" href="store-locator.html">
              <i className="icofont-focus fs-5" />
